...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2023 at 07:30 AM
...
INSERT INTO `customerprodcuts` (`PurchaseID`, `CustomerID`, `ProdcutID`, `PurchaseDate`, `RenewDate`) VALUES
(1, 1, 1, '2023-12-09', '2024-12-09'),
(2, 2, 2, '2023-12-10', '2024-12-10'),
(3, 1, 3, '2023-12-11', '2024-12-11'),
(4, 3, 4, '2023-12-12', '2024-12-12'),
(5, 1, 5, '2023-12-13', '2024-12-13'),
(1220, 4, 1, '2023-12-09', '2024-12-09');
...
(3005, 2, 'Strategy Discussion', '2023-12-13', '11:00:00');
...
ALTER TABLE `customerprodcuts`
  ...
  ADD KEY `Customer_fF` (`CustomerID`);
...
--
ALTER TABLE `customercontactaddresses`
  ADD CONSTRAINT `CustomerContactAddresses` FOREIGN KEY (`ID`) REFERENCES `customer` (`ID`);

--
-- Constraints for table `customercontactphones`
--
ALTER TABLE `customercontactphones`
  ADD CONSTRAINT `CustomerContactPhones` FOREIGN KEY (`ID`) REFERENCES `customer` (`ID`);

--
-- Constraints for table `customerpaydetails`
--
ALTER TABLE `customerpaydetails`
  ADD CONSTRAINT `CustomerPayDetails_FK` FOREIGN KEY (`ID`) REFERENCES `customer` (`ID`);
...
ALTER TABLE `customerprodcuts`
  ...
  ADD CONSTRAINT `Customer_fF` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`ID`);
